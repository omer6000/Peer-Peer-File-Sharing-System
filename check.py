...
def testFileRehashing(nodes, files, sp):
	...
	# print("Port:",nodes[0].port, "Key:",nodes[0].key, "Files:", list(map(nodes[0].hasher,nodes[0].files)),list(map(nodes[0].hasher,nodes[0].backUpFiles)),nodes[0].hasher(nodes[0].successor[0] + str(nodes[0].successor[1])))
	# print("Port:",nodes[1].port, "Key:",nodes[1].key, "Files:", list(map(nodes[1].hasher,nodes[1].files)),list(map(nodes[1].hasher,nodes[1].backUpFiles)),nodes[1].hasher(nodes[1].successor[0] + str(nodes[1].successor[1])))
	# print("Port:",nodes[2].port, "Key:",nodes[2].key, "Files:", list(map(nodes[2].hasher,nodes[2].files)),list(map(nodes[2].hasher,nodes[2].backUpFiles)),nodes[2].hasher(nodes[2].successor[0] + str(nodes[2].successor[1])))
	# print("Port:",nodes[3].port, "Key:",nodes[3].key, "Files:", list(map(nodes[3].hasher,nodes[3].files)),list(map(nodes[3].hasher,nodes[3].backUpFiles)),nodes[3].hasher(nodes[3].successor[0] + str(nodes[3].successor[1])))
	# print("Port:",nodes[4].port, "Key:",nodes[4].key, "Files:", list(map(nodes[4].hasher,nodes[4].files)),list(map(nodes[4].hasher,nodes[4].backUpFiles)),nodes[4].hasher(nodes[4].successor[0] + str(nodes[4].successor[1])))
	# print("Port:",nodes[5].port, "Key:",nodes[5].key, "Files:", list(map(nodes[5].hasher,nodes[5].files)),list(map(nodes[5].hasher,nodes[5].backUpFiles)),nodes[5].hasher(nodes[5].successor[0] + str(nodes[5].successor[1])))
	# print("Port:",nodes[6].port, "Key:",nodes[6].key, "Files:", list(map(nodes[6].hasher,nodes[6].files)),list(map(nodes[6].hasher,nodes[6].backUpFiles)),nodes[6].hasher(nodes[6].successor[0] + str(nodes[6].successor[1])))
	# print("Port:",nodes[7].port, "Key:",nodes[7].key, "Files:", list(map(nodes[7].hasher,nodes[7].files)),list(map(nodes[7].hasher,nodes[7].backUpFiles)),nodes[7].hasher(nodes[7].successor[0] + str(nodes[7].successor[1])))
	for i in range(len(files)):
		for j in range(len(nodes)):
